...
function initRuntimeSocketService() {
  const hosts = "192.168.10.11,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_vzy6HO";
  ...
  */
  constructor(arg = {}) {
    if (!isPlainObject(arg)) {
      arg = {};
      index$1.__f__("warn", "at node_modules/uview-ui/libs/luch-request/core/Request.js:39", "设置全局参数必须接收一个Object");
    }
...
function checkBoundary(num) {
  {
    if (num > Number.MAX_SAFE_INTEGER || num < Number.MIN_SAFE_INTEGER) {
      index$1.__f__("warn", "at node_modules/uview-ui/libs/function/digit.js:45", `${num} 超出了精度限制，结果可能不正确`);
    }
  }
}
...
function addUnit(value = "auto", unit = ((_b) => (_b = ((_a) => (_a = index$1 == null ? void 0 : index$1.$u) == null ? void 0 : _a.config)()) == null ? void 0 : _b.unit)() ?? "px") {
  value = String(value);
...
function error(err) {
  {
    index$1.__f__("error", "at node_modules/uview-ui/libs/function/index.js:250", `uView提示：${err}`);
  }
}
...
{
  index$1.__f__("log", "at node_modules/uview-ui/libs/config/config.js:6", `
...
index$1.$u = $u;
const install2 = (Vue) => {
  Vue.filter("timeFormat", (timestamp, format) => index$1.$u.timeFormat(timestamp, format));
  Vue.filter("date", (timestamp, format) => index$1.$u.timeFormat(timestamp, format));
  Vue.filter("timeFrom", (timestamp, format) => index$1.$u.timeFrom(timestamp, format));
  Vue.prototype.$u = $u;
  Vue.mixin(mixin$1);
};
const uView = {
